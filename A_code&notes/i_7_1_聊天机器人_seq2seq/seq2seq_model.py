...
class Seq2SeqModel(object):
    ...
    def __init__(self,
        ...
        if num_samples > 0 and num_samples < self.target_vocab_size:
            ...
            w_t = tf.compat.v1.get_variable("proj_w", [self.target_vocab_size, size], dtype=dtype)
            w = tf.transpose(w_t)
            # b = tf.get_variable("proj_b", [self.target_vocab_size], dtype=dtype)
            b = tf.compat.v1.get_variable("proj_b", [self.target_vocab_size], dtype=dtype)
        ...
        for i in xrange(buckets[-1][1] + 1):
            ...
            self.target_weights.append(tf.compat.v1.placeholder(dtype, shape=[None],
